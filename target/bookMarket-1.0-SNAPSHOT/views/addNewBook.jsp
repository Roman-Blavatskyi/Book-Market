...
<div id="main">
<form id="formView" action="/newBook", method="post">

    <input name="bookName" id="name" type="text" placeholder="Ім'я книги">

    <input name="genreName" id="genre" type="text" placeholder="Ім'я жанру">

    <input name="priceName" id="price" type="text" placeholder="Ціна">

    <input name="descriptionName" id="description" type="text" placeholder="Аннотація">

    <input name="urlName" id="urlImage" type="text" placeholder="Картинка">
